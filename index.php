...
<head>
   ...
   <title>Gmail Style Inbox page </title>
...
<div id="listData" class="list-form-container"> 
    <?php
        ...
        $connection = imap_open('{imap.gmail.com:993/imap/ssl}INBOX', 'your_email_id', '{your_email_password}') or die('Cannot connect to Gmail: ' . imap_last_error());
		   ...
		   <?php
		    ...
		    <!-- Nav tabs -->
                <div class="tab-pane fade in active" id="home">
					...
					<span class="name" style="min-width: 120px; display: inline-block;"><?php echo $overview[0]->from; ?></span>
					<span class=""><?php 
					echo $overview[0]->subject /*,  $partialMessage */ ;	
// echo $overview[0]->subject, $message ;						
					?></span>
